...
export const posts = [
  {
    ...
    metaDescription:
      "Five practical finance moves PE sponsors and portco CFOs can execute in 60–120 days to lift defensible EBITDA before a process, without the cosmetic adjustments buyers will haircut.",
    date: "2026-04-02",
    readTime: "9 min read",
    category: "PE Advisory",
    excerpt:
      "The EBITDA you walk into a process with is not the EBITDA you end up defending. Here are five moves, spanning revenue recognition, expense reclassification, working capital normalization, add-back documentation, and run-rate methodology, that materially shift the enterprise value bridge without inviting a quality-of-earnings haircut.",
    content: `
...
<ul>
  <li>"Rebranding" or "website refresh" expenses, which buyers argue are ongoing marketing investments</li>
  <li>System implementations, usually treated as ordinary course for a company at your scale</li>
  <li>Management bonuses tied to the transaction, sometimes defensible and often not, depending on how they are structured</li>
...
<p><strong>First: are the numbers real?</strong> This is the accounting-integrity layer. The provider will reconcile reported revenue to cash, to signed contracts, and to shipping or delivery evidence. They will test cutoff, checking whether revenue booked in December actually belongs to December. They will scrub AR aging for customers that no longer exist and inventory for slow-moving or obsolete stock being carried at cost. This layer usually takes two to three weeks and, if the books are clean, produces minor adjustments.</p>
...
<p>A business that generates 70% of its traffic from Google or 60% of its revenue through Amazon has a different risk profile than a diversified business with the same total revenue. Channel dependency is a version of customer concentration, where the "customer" is the platform, and buyers discount accordingly. When Google changes its algorithm or Amazon changes its terms, the business does not get a vote.</p>
...
`,
...

  {
    ...
    metaDescription:
      "The monthly Excel board pack is dying. Here is what a modern PE reporting stack looks like, from ERP to ETL to Power BI to automated board decks, and what actually changes when sponsors see real-time numbers.",
    date: "2026-04-09",
...
<ul>
  <li>A CEO/CFO operating dashboard covering revenue, EBITDA, cash, covenant headroom, and top variances</li>
  <li>A sponsor dashboard with portfolio-level metrics, comparison to plan, comparison to prior year, and rolling forecast</li>
  <li>Functional dashboards for the operators who own them: sales pipeline, collections, inventory, headcount</li>
...
<p>Not every metric belongs in real time. Some metrics, such as gross margin by customer, lifetime value, and cohort retention, are genuinely monthly or quarterly. Others need to be visible at the day or week level.</p>
...
<ul>
  ...
  <li><strong>EBITDA,</strong> with a rolling full-year view, not just the current month. The single most useful view is LTM EBITDA over the last 18 months as a line chart, which shows the trajectory that a board pack rarely conveys.</li>
  ...
  <li><strong>Working capital:</strong> DSO, DPO, DIO, and net working capital, tracked against trend and plan.</li>
</ul>
...
<p><strong>Weeks 1 to 2: discovery and data assessment.</strong> Inventory source systems. Assess data quality. Define the business logic, including what is revenue, what is EBITDA, and what is working capital, and reconcile to the current reporting. Identify the five to ten metrics that will be on the v1 dashboard and the twenty-ish that will follow.</p>
...
<p>In pure labor terms, the math works. In decision-quality terms, namely faster interventions, better board conversations, and diligence-readiness, the return is larger and harder to quantify, but it is the reason this work has become table stakes for well-run PE-backed businesses.</p>
...
<p><strong>Exit preparation and transaction readiness.</strong> A controller makes sure the books are auditable. A CFO makes sure the business is sellable, and the two are very different tasks. Add-back documentation, working capital normalization, run-rate methodology, management interview preparation, data room architecture, and sell-side QoE coordination all live on the CFO's side of the line, and they are the reason the hold period either compounds or dissipates value in the last twelve months.</p>
...
<ul>
  <li>A redesigned monthly reporting package that is shorter and more focused, with commentary that addresses "what changed and why" rather than "here are the numbers"</li>
